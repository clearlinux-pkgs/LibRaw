...
Source0  : https://www.libraw.org/data/LibRaw-0.19.2.tar.gz
...
%prep
%setup -q -n LibRaw-0.19.2
pushd ..
cp -a LibRaw-0.19.2 buildavx2
popd
pushd ..
cp -a LibRaw-0.19.2 buildavx512
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1546544734
...
/usr/lib64/haswell/libraw.so.19.0.0
/usr/lib64/haswell/libraw_r.so.19
/usr/lib64/haswell/libraw_r.so.19.0.0
/usr/lib64/libraw.so.19
/usr/lib64/libraw.so.19.0.0

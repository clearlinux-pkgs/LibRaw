...
Source0  : https://www.libraw.org/data/LibRaw-0.19.3.tar.gz
...
%prep
%setup -q -n LibRaw-0.19.3
pushd ..
cp -a LibRaw-0.19.3 buildavx2
popd
pushd ..
cp -a LibRaw-0.19.3 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562227642
...
/usr/lib64/haswell/avx512_1/libraw.so.19.0.1
/usr/lib64/haswell/avx512_1/libraw_r.so.19
/usr/lib64/haswell/avx512_1/libraw_r.so.19.0.1
/usr/lib64/haswell/libraw.so.19
/usr/lib64/haswell/libraw.so.19.0.1
/usr/lib64/haswell/libraw_r.so.19
/usr/lib64/haswell/libraw_r.so.19.0.1
/usr/lib64/libraw.so.19
/usr/lib64/libraw.so.19.0.1
/usr/lib64/libraw_r.so.19
/usr/lib64/libraw_r.so.19.0.1

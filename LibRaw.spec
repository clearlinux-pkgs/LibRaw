...
%prep
%setup -q -n LibRaw-0.21.0
cd %{_builddir}/LibRaw-0.21.0
pushd ..
cp -a LibRaw-0.21.0 buildavx2
popd
pushd ..
cp -a LibRaw-0.21.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672159256
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/glibc-hwcaps/x86-64-v3/libraw.so.23
/usr/lib64/glibc-hwcaps/x86-64-v3/libraw.so.23.0.0
/usr/lib64/glibc-hwcaps/x86-64-v3/libraw_r.so.23
/usr/lib64/glibc-hwcaps/x86-64-v3/libraw_r.so.23.0.0
/usr/lib64/glibc-hwcaps/x86-64-v4/libraw.so.23
/usr/lib64/glibc-hwcaps/x86-64-v4/libraw.so.23.0.0
/usr/lib64/glibc-hwcaps/x86-64-v4/libraw_r.so.23
/usr/lib64/glibc-hwcaps/x86-64-v4/libraw_r.so.23.0.0

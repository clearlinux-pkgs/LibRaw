...
Source0  : https://www.libraw.org/data/LibRaw-0.19.1.tar.gz
...
%prep
%setup -q -n LibRaw-0.19.1
pushd ..
cp -a LibRaw-0.19.1 buildavx2
popd
pushd ..
cp -a LibRaw-0.19.1 buildavx512
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1542910501

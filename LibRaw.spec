...
%prep
%setup -q -n LibRaw-0.20.0
cd %{_builddir}/LibRaw-0.20.0
pushd ..
cp -a LibRaw-0.20.0 buildavx2
popd
pushd ..
cp -a LibRaw-0.20.0 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595524277
...
cp %{_builddir}/LibRaw-0.20.0/LICENSE.CDDL %{buildroot}/usr/share/package-licenses/LibRaw/c24b9c7ef03687bf0141f85a1b7ed81459944c3c
cp %{_builddir}/LibRaw-0.20.0/LICENSE.LGPL %{buildroot}/usr/share/package-licenses/LibRaw/39a21f33cadea18adcc23bf808d7d5ea6419c8b1
pushd ../buildavx512/
%make_install_avx512
popd
pushd ../buildavx2/

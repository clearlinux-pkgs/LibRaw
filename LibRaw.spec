...
Source0  : https://www.libraw.org/data/LibRaw-0.18.12.tar.gz
...
%prep
%setup -q -n LibRaw-0.18.12
pushd ..
cp -a LibRaw-0.18.12 buildavx2
popd
pushd ..
cp -a LibRaw-0.18.12 buildavx512
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1528726856

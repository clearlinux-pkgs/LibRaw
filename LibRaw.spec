...
Source0  : https://www.libraw.org/data/LibRaw-0.18.9.tar.gz
...
%prep
%setup -q -n LibRaw-0.18.9
pushd ..
cp -a LibRaw-0.18.9 buildavx2
popd
pushd ..
cp -a LibRaw-0.18.9 buildavx512
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1524679793

...
Source0  : https://www.libraw.org/data/LibRaw-0.19.4.tar.gz
...
%prep
%setup -q -n LibRaw-0.19.4
pushd ..
cp -a LibRaw-0.19.4 buildavx2
popd
pushd ..
cp -a LibRaw-0.19.4 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565184894

...
Source0  : https://www.libraw.org/data/LibRaw-0.18.10.tar.gz
...
%prep
%setup -q -n LibRaw-0.18.10
pushd ..
cp -a LibRaw-0.18.10 buildavx2
popd
pushd ..
cp -a LibRaw-0.18.10 buildavx512
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1525362687

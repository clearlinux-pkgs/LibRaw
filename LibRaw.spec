...
Source0  : https://www.libraw.org/data/LibRaw-0.21.3.tar.gz
...
%prep
%setup -q -n LibRaw-0.21.3
cd %{_builddir}/LibRaw-0.21.3
pushd ..
cp -a LibRaw-0.21.3 buildavx2
popd
pushd ..
cp -a LibRaw-0.21.3 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726707090
